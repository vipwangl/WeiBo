...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _retwitterView = [[UIView alloc]init];
        _retwitterView.backgroundColor = [UIColor colorWithRed:(225.0 / 255.0) green:1 blue:1 alpha:.5];
        [_retwitterView addSubview:_retwitterUserNameLabel];
        [_retwitterView addSubview:_retwitterContentLabel];
        [_retwitterView addSubview:_retwitterImage];
...
//        [self.contentView addSubview:_retwitterImage];
        ...
        [self.contentView addSubview:_retwitterView];

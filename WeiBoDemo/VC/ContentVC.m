...
{
    [self performSegueWithIdentifier:@"ToFansVC" sender:self];
}
...
//    cell.contentLabel.backgroundColor = [UIColor grayColor];
    ...
    if(obj.retweetedObj)
    {
        ...
        cell.retwitterUserNameLabel.frame = CGRectMake(10, 0, 200, 30);
        h += cell.retwitterUserNameLabel.frame.size.height;
        
        cell.retwitterContentLabel.text = obj.retweetedObj.content;
        cell.retwitterContentLabel.frame = CGRectMake(cell.retwitterUserNameLabel.frame.origin.x + 25, cell.retwitterUserNameLabel.frame.size.height, 200, [self getContentHeight:obj.retweetedObj withWidth:200]);
    ...
    if(obj.retweetedObj.imgUrl)
    {
        ...
        cell.retwitterImage.frame = CGRectMake(cell.retwitterContentLabel.frame.origin.x, h - cell.contentLabel.frame.size.height - cell.contentLabel.frame.origin.y + 5, 150, 150);
    ...
    if(obj.retweetedObj)
    {
        cell.retwitterView.hidden = NO;
        cell.retwitterView.frame = CGRectMake(cell.userNameLabel.frame.origin.x, cell.contentLabel.frame.origin.y + cell.contentLabel.frame.size.height + 10, 240, h - cell.contentLabel.frame.size.height - cell.contentLabel.frame.origin.y + 15);
    }
    else
    {
        cell.retwitterView.hidden = YES;
    }
    cell.sourceLabel.text = obj.source;
    cell.sourceLabel.frame = CGRectMake(cell.avatar.frame.origin.x + 20, h + 30, 200, 30);
